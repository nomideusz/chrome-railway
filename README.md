...
## Dependencies for Google Chrome Hosting

- None — single service, no database

### Deployment Dependencies

- [linuxserver.io Google Chrome image docs](https://docs.linuxserver.io/images/docker-chrome/)
...
- Google Chrome is memory-hungry: give the service 1–2 GB. Heavy tab hoarding needs more.
...
## Why Deploy Google Chrome on Railway?

Railway is a singular platform to deploy your infrastructure stack. Railway will host your infrastructure so you don't have to deal with configuration, while allowing you to vertically and horizontally scale it.

By deploying Google Chrome on Railway, you are one step closer to supporting a complete full-stack application with minimal burden. Host your servers, databases, AI agents, and more on Railway.
